...
// 生成笛卡尔积数组
var combine = function combine(arr) {
    var r = [];
    (function f(t, a, n) {
...
module.exports = {
    ...
    isBoolean: isBoolean,
    isString: isString,
    isUndefined: isUndefined, // 判断是不是undefined
    isNull: isNull, // 判断是不是null
    isNil: isNil, // 判断是不是 null或undefined
    isEmpty: isEmpty,
    isObjectNull: isObjectNull, // 判断对象是否为空
    isEmail: isEmail,
